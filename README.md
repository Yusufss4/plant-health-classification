...
**[Watch the demo video](https://youtube.com/shorts/rRXCOvp1peQ)**: a real leaf, a live camera, and predictions in about a tenth of a second.
...
| **Inference** | **~68 ms** per frame (live) |
...
```
Camera  →  Resize & normalize  →  MobileNet-V3 (ONNX)  →  Healthy / Diseased / Background  →  Live web page
```
